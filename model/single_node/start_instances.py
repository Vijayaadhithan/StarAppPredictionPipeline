...
instance_prod = nova.servers.create(name="group4_prod_server_"+str(identifier), image=image, flavor=flavor, key_name='project-cluster',userdata=userdata_prod, nics=nics,security_groups=secgroups)
instance_dev = nova.servers.create(name="group4_dev_server_"+str(identifier), image=image, flavor=flavor, key_name='project-cluster',userdata=userdata_dev, nics=nics,security_groups=secgroups)
